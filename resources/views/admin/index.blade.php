    ...
    <aside class="w-64 bg-white shadow-lg">
        ...
        <nav class="p-4">
            <ul class="space-y-2">
                ...
                <li>
                    <a href="" class="flex items-center p-2 rounded-lg text-gray-700 hover:bg-indigo-50">
                        <i class="fa-solid fa-chart-pie mr-2"></i> Reports
                    </a>
                </li>
                <li>
                    <a href="" class="flex items-center p-2 rounded-lg text-gray-700 hover:bg-indigo-50">
    ...
    <div class="flex-1 flex flex-col">
        <header class="flex items-center justify-between bg-white px-6 py-4 border-b border-gray-200">
            ...
            <div class="flex items-center space-x-4">
                ...
                <img class="w-10 h-10 rounded-full border" src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name ?? 'Admin') }}" alt="User">
            </div>
        </header>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                <div class="bg-white rounded-xl shadow-md p-6">
                    ...
                    <ul class="divide-y divide-gray-200">
                        ...
                        <li class="py-3">
                            <span class="font-semibold text-yellow-600">Family F</span> nearing expense limit (92% used).
                        </li>
                        <li class="py-3">
                            <span class="font-semibold text-green-600">Family A</span> achieved ₱12,000 in savings this month.
                        </li>
                    </ul>
                </div>
            </div>
