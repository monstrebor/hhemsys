                ...
                <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
                    ...
                    <tr>
                        <td style="padding:30px;color:#1f2937;">
                            <h2 style="font-size:22px;font-weight:700;margin-bottom:10px;">📧 Email Address Updated</h2>
                            <p style="font-size:16px;margin-bottom:15px;">
                                Hello {{ $details['name'] }},
                            </p>
                            <p style="font-size:16px;margin-bottom:15px;">
                                This is a notification that your account email address has been changed.
                            </p>

                            <p style="font-size:16px;margin-bottom:8px;">
                                <strong>New Email Address:</strong> {{ $details['new_email'] }}
                            </p>

                            <p style="font-size:15px;margin:20px 0;">
                                ⚠️ If you did <strong>not</strong> make this change, please contact support
                            ...
                            <p style="font-size:14px;color:#6b7280;">
                                This message was sent to your previous email address for security verification.
                            </p>
                        </td>
                    </tr>
