<div class="max-w-md mx-auto mt-10 bg-white shadow-md rounded-xl p-6">
    ...
    <form action="{{ route('password.update') }}" method="POST" class="space-y-4">
        ...
        <div class="max-w-md mx-auto mt-10 bg-white shadow-md rounded-xl p-6 space-y-4">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <div class="absolute right-3 top-3 cursor-pointer" onclick="toggleVisibility('current_password')">
                        {{-- Eye Open (show) --}}
                        <svg id="current_password_show" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500"
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <div class="absolute right-3 top-3 cursor-pointer" onclick="toggleVisibility('{{ $id }}')">
                        {{-- Show --}}
                        <svg id="{{ $id }}_show" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500"
                            fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        {{-- Hide --}}
                        <svg id="{{ $id }}_hide" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500 hidden"
                            fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.269-2.943-9.543-7a10.04 10.04 0 012.877-4.148M6.6 6.6A9.969 9.969 0 0112 5c4.478 0 8.269 2.943 9.543 7a9.964 9.964 0 01-4.206 5.177M3 3l18 18" />
                        </svg>
